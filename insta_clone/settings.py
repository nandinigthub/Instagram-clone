...
SECRET_KEY = 'django-insecure-7n*+usk=h7f14yhjzgfxf@ysqxjtdi=m%bg#a4j#mbc45zppsm'
...
MIDDLEWARE = [
    ...
    'social_django.middleware.SocialAuthExceptionMiddleware', #google-sso
]
...
LOGIN_REDIRECT_URL = 'home_feed_view'
